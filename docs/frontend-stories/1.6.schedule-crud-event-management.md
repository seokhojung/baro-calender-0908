# Story 1.4: 스케줄 CRUD 및 이벤트 관리 시스템
...
### **기술 요구사항**
- [ ] ShadCN UI MCP 서버 블록 활용 (forms-01, calendar-01, table-01)
- [ ] Apollo Client GraphQL 구독을 통한 실시간 업데이트
...
### **테스트 요구사항**
- [ ] Jest + RTL 단위 테스트 (80% 커버리지)
- [ ] Playwright E2E 일정 관리 플로우 테스트
- [ ] 접근성 테스트 (jest-axe)
